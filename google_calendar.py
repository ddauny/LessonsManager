...
# Path to client secrets which user must provide in instance/credentials.json
CREDENTIALS_PATH = os.path.join(os.path.dirname(__file__), 'instance', 'credentials.json')
...
def build_flow(redirect_uri):
    if not os.path.exists(CREDENTIALS_PATH):
        raise FileNotFoundError('Google credentials.json not found at instance/credentials.json')
